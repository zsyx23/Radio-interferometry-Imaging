function [xsol, L1_v, L1_vp, L2_v, L2_vp, delta_v, sol_v, snr_v, no_sub_itr_v, v1, v2, sol_reweight_v] = pdfb_bpcon_par_sim_rescaled_precond(y, epsilont, epsilonts, epsilon, epsilons, A, At, T, pU, W, Psi, Psit, Psiw, Psitw, param)
%
...
% figure; imagesc(real(log10((xsol))));%set(gca,'YDir','normal');
% axis off;
% colorbar, axis image; caxis([-5.6 -3.6]);%title('Recovered image');
% colormap(cubehelix);
