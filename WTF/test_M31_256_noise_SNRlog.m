...
input_snr_sum = 10:5:50 ;
average_times= 1 ;
Maxiter= 100 ;soft_threshold_values=1e-6; forward_descent_step_size=0.49;
lambda_IUWT= 1e-5 ;  gamma_IUWT = 0.5 ;  iter_max_IUWT  =  100 ;
...
SNRlog_sum_ave_PD=zeros(1,length(per));
...
for iiiii=1:1:length(input_snr_sum)
param_sampling.p= 0.4 ;  
input_snr=input_snr_sum(1,iiiii);
