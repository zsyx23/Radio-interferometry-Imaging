...
figure; imagesc(real(log10((im(275:751,:)))));set(gca,'YDir','normal');axis off;
...
Maxiter= 200 ;soft_threshold_values=3e-6; forward_descent_step_size=0.49;
lambda_IUWT= 1e-5 ;  gamma_IUWT = 1 ;  iter_max_IUWT  =  200 ;
gamma_WTF= 1 ;  iter_max_WTF= 100 ;
f_log_min=-3.5;
f_log_max=0;
f_res=0.0005;
f_err=0.005;
...
uw=uvw(:,1);vw=uvw(:,2);
% maxProjBaseline=max(sqrt((uw.^2)+(vw.^2)));
% uw=uw./maxProjBaseline.*pi;
% vw=vw./maxProjBaseline.*pi;
figure;plot(uw,vw,'.r');
...
figure; imagesc(real(log10((soln_PD(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([f_log_min f_log_max]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
figure; imagesc(real(((residualn_PD(275:751,:)))));set(gca,'YDir','normal');axis off;
...
error_PD = im - soln_PD;
figure; imagesc(real(((error_PD(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_err f_err]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);

SNR_PD = 20 * log10(norm(im(275:751,:))/norm(error_PD(275:751,:)));
TIME_PD=tend;
...
% colormap(cubehelix);
figure; imagesc(real(log10((soln_PPD(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([f_log_min f_log_max]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
% figure;imagesc(residualn), colorbar, axis image; title('Residual image');
figure; imagesc(real(((residualn_PPD(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_res f_res]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);

error_PPD = im - soln_PPD;
figure; imagesc(real(((error_PPD(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_err f_err]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);

% SNR_PPD = 20 * log10(norm(im(275:751,:))/norm(error_PDD(275:751,:)));
SNR_PPD=10*log10((sum(sum(im(275:751,:).^2)))/(sum(sum((real(soln_PPD(275:751,:))-im(275:751,:)).^2))));
TIME_PPD=tend;
...
% param_admm.gamma = soft_threshold_values*evl; % convergence parametter
...
% % colormap(cubehelix);
% figure; imagesc(real(log10((soln_ADMM(275:751,:)))));set(gca,'YDir','normal');axis off;
% colorbar, axis image; caxis([f_log_min f_log_max]);%title('Recovered image');
% colormap(cubehelix);
% set(gca,'position',[-0.22,0.02,1.4,0.90])
% set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
% 
% % figure;imagesc(residualn), colorbar, axis image; title('Residual image');
% figure; imagesc(real(((residualn_ADMM(275:751,:)))));set(gca,'YDir','normal');axis off;
% colorbar, axis image; caxis([-f_res f_res]);%title('Recovered image');
% colormap(cubehelix);
% set(gca,'position',[-0.22,0.02,1.4,0.90])
% set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
% figure; imagesc(real(((error_ADMM(275:751,:)))));set(gca,'YDir','normal');axis off;
% colorbar, axis image; caxis([-f_err f_err]);%title('Recovered image');
% colormap(cubehelix);
% set(gca,'position',[-0.22,0.02,1.4,0.90])
% set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
% 
% % SNR_ADMM = 20 * log10(norm(im(275:751,:))/norm(error_ADMM(275:751,:)));
% SNR_ADMM=10*log10((sum(sum(im(275:751,:).^2)))/(sum(sum((real(soln_ADMM(275:751,:))-im(275:751,:)).^2))));
% TIME_ADMM =tend;
...
% colormap(cubehelix);
figure; imagesc(real(log10((soln_IUWT(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([f_log_min f_log_max]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
% residualn = residualn + residualn_;
% figure;imagesc(residualn), colorbar, axis image; title('Residual image');
figure; imagesc(real(((residualn_IUWT(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_res f_res]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
figure; imagesc(real(((error_IUWT(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_err f_err]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);

% SNR_IUWT = 20 * log10(norm(im(275:751,:))/norm(error_IUWT(275:751,:)))
SNR_IUWT=10*log10((sum(sum(im(275:751,:).^2)))/(sum(sum((real(u_IUWT(275:751,:))-im(275:751,:)).^2))));
TIME_IUWT =tend;
...
% figure;imagesc(real(log10((soln_WTF)))); colorbar; axis image;title('Recovered image');caxis([-3.5 0]);
% colormap(cubehelix);
figure; imagesc(real(log10((soln_WTF(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([f_log_min f_log_max]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
% residualn = residualn + residualn_;
% figure;imagesc(residualn), colorbar, axis image; title('Residual image');
figure; imagesc(real(((residualn_WTF(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_res f_res]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);
...
figure; imagesc(real(((error_WTF(275:751,:)))));set(gca,'YDir','normal');axis off;
colorbar, axis image; caxis([-f_err f_err]);%title('Recovered image');
colormap(cubehelix);
set(gca,'position',[-0.22,0.02,1.4,0.90])
set(gcf,'unit','normalized','position',[0.2,0.2,0.4,0.3]);

% SNR_WTF = 20 * log10(norm(im(275:751,:))/norm(error_WTF(275:751,:)));
SNR_WTF=10*log10((sum(sum(im(275:751,:).^2)))/(sum(sum((real(im_rec(275:751,:))-im(275:751,:)).^2))));
TIME_WTF =tend;
