function [MODEL]=run_imager_per(json_filename, NameValueArgs)
...
%% main function
% imager_per(main.dataFile, main.imPixelSize, main.imDimx, main.imDimy, param_general, main.runID);
[MODEL]=imager_per(main.dataFile, main.imPixelSize, main.imDimx, main.imDimy, param_general, main.runID);
end