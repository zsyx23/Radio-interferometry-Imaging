function [MODEL]=imager_per(pathData, imPixelSize, imDimx, imDimy, param_general, runID)
...
%     fitswrite(single(dirty), fullfile(param_imaging.resultPath, 'dirty_yx.fits'));%%%%%%%% yx
%     fitswrite(single(PSFPeak), fullfile(param_imaging.resultPath, 'PSFPeak_yx.fits'));%%%%%%%% yx
